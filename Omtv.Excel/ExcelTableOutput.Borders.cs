...
namespace Omtv.Excel
{
    public partial class ExcelTableOutput
    {
        ...
        private UInt32 GetBorders(Style? tableStyle = null, Style? cellStyle = null, Boolean isLeft = false, Boolean isRight = false, Boolean isTop = false, Boolean isBottom = false)
        {
