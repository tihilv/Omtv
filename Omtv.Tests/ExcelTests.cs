    ...
    public async Task RegularTest()
    {
        using (var stream = new MemoryStream())
        {
            var doc = "<document>" +
                      ...
                      "<row styles=\"odd\" height=\"50mm\"><cell align=\"center\" width=\"70%\" parents=\"borders\" foreColor=\"red\">v11</cell><cell rowSpan=\"2\" valign=\"before\" align=\"center\" width=\"20px\">v12</cell><cell>v13</cell></row>" +
